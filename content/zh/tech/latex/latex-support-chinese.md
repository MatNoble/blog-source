...
由于 CTeX 中文套装[^1]已停止更新(上一次更新是 2012 年), 所以强烈建议[ Linux 和 Windows 用户安装 TeXLive](https://blog.matnoble.top/posts/install-texlive/), Mac OSX 用户安装 [MacTeX](http://www.tug.org/mactex/).　
