+++
title = "有限元简述(1)：逼近向量与伽辽金法"
description = "有限元简述系列第一篇。通过逼近二维及多维向量的例子，深入浅出地介绍了最小二乘法与伽辽金法（Galerkin Method）的数学原理及其在有限元中的应用。重点通过正交性理解两种方法的一致性。"
categories = ["MATH","简述有限元"]
tags = ["有限元"]
keywords = ["有限元","FEM", "最小二乘法", "伽辽金法", "逼近向量", "正交性", "Galerkin method"]
...
{{< imgcap src="/images/fem/fem_cover.png" title="简述有限元：逼近向量" >}}
...
{{< imgcap src="/images/fem/vector_approx_2d.png" title="一维向量最佳逼近二维向量" width="400" >}}
...
\begin{equation}
\sum*{j_0}^NA*{i, j}c_j = b_i, \quad i = 0, \cdots, N.
\end{equation}
...
下次讨论[逼近函数问题]({{< relref "function-approximation-intro.md" >}}).
