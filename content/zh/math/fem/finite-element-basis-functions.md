+++
title = "有限元简述(5)：有限元基函数与网格划分"
description = "有限元简述系列第五篇。深入探讨有限元基函数的构造原理，特别是具有紧支撑特性的分段多项式基函数（帽子函数）。详细解释有限元网格、单元、节点、全局编号与局部编号的概念，以及刚度矩阵的组装过程。"
categories = ["MATH","简述有限元"]
tags = ["有限元"]
keywords = ["有限元","FEM", "有限元基函数", "网格划分", "刚度矩阵", "紧支撑", "帽子函数", "单元与节点"]
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/64498351-25f9-435e-8951-704f5883d9e0.png" title="简述有限元: 逼近函数 IV" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/08a52fa9-b8f3-46c5-b6ff-1d7a9703bbfc.png" title="简述有限元: 例题 1" width="500" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/c8dfa667-6a58-48d2-9ec7-7123dae6c7bc.png" title="简述有限元: 例题 1 结果展示" width="300" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/ad0d5094-04f7-412e-a46f-b05819c0218f.png" title="" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/2be6ad26-cf1e-41e7-9c57-c5941b2e9dbe.png" title="结果展示" >}}

- 插值法

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/2ac593aa-fe3c-4ee3-93c7-fe0cac07f874.png" title="" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/fe705f59-213e-4579-b5cb-628dde96dd9a.png" title="结果展示" >}}
...
在之前 3 期推送([逼近函数]({{< relref "function-approximation-intro.md" >}}))中, 基函数 $\psi_i(x), i \in {\mathcal{I}_s}$ 在整个区域 $\Omega$ 上一般都是非零的, 如下图所示.

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/856a7f13-620b-426b-909a-31f57f18c3f7.png" title="u(x)=4\psi_0(x)-\frac{1}{2}\psi_1(x)" >}}

而有限元法要求基函数有[紧支撑](http://mathworld.wolfram.com/CompactSupport.html "紧支撑"), 即它们只有在一小部分区域内是非零的, 在大部分区域都是零. 另外, 一般要求基函数是分段多项式函数, 如下图所示

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/355f0ce0-2714-44ed-8c01-7939ff089172.png" title="" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/da8653b4-fd8f-4f76-958c-746ab875e1c3.png" title="有 5 个单元 6 个节点的有限元网格" >}}
...
> $\Omega=[0, 1]$ 内剖分为两个单元:
>
> {{< imgcap src="https://imgkr.cn-bj.ufileos.com/f8f1b018-16d8-455c-99ea-ebc117f6c033.png" title="2 个单元 5 个节点的单位有限元网格" >}}
>
> \begin{aligned}
> \Omega^{(0)}=[0, 0.4]\\
> \Omega^{(1)}=[0.4, 1]
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/b1fd8d22-ae6f-4dc7-834d-a06911bec573.png" title="$\Omega^{(1)}$ 内的三个基函数" >}}
...
因此, $A*{ij} = \int*{\Omega^{(e)}} \varphi \_i(x) \varphi_j(x) {\rm d} x $ 在系数矩阵中大多等于 0.
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/5b252f1d-7d4a-4367-a7ae-dd95be8b85ec.png" title="P1 元" >}}

#### 分段二次有限元基函数

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/8c2784e1-11de-4f02-95f0-36ba5303b9af.png" title="P2 元" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/af886738-a916-4c3a-82fb-d191a368ffd3.png" title="系数矩阵" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/92813566-6697-4c2f-8205-e71f1cf3531a.png" width="500" title="有限元公式" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/91613bcd-7a64-48ac-9f13-4d75f2a6216a.png" title="右端项" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/82d4dc49-5731-4afa-a036-e5da8b2e9bb2.png" title="左: 2 个节点  右: 4 个节点" >}}

### 小结

有限元基函数可以保证最小二乘法的系数矩阵是稀疏的, 而且基函数是简单的多项式.

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/64498351-25f9-435e-8951-704f5883d9e0.png" title="帽子函数" >}}
