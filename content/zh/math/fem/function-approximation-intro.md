+++
title = "有限元简述(2)：逼近函数与最小二乘法"
description = "有限元简述系列第二篇。从逼近向量推广到逼近函数，详细讲解如何利用最小二乘法和伽辽金法寻找最佳逼近函数。通过线性代数方程组的求解，揭示函数空间中距离与投影的概念。"
categories = ["MATH","简述有限元"]
tags = ["有限元"]
keywords = ["有限元","FEM", "逼近函数", "最小二乘法", "伽辽金法", "线性方程组", "函数空间"]
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/2183d598-1f26-450f-b94d-daabdfab77d6.jpg" title="简述有限元: 逼近函数 I" >}}

<!--more-->

## 前情回顾

第一期讨论了[逼近向量]({{< relref "vector-approximation.md" >}}), 利用 `最小二乘法` 和 `伽辽金法` 推到出相同的结果. 理解..正交性..是上一期最重要的目的.
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/1ffd7797-070a-47d0-bc4b-6716b4267208.png" title="二维空间逼近三维空间向量" width="400" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/3553cebe-720f-4b3b-beab-f698ed5c7c4a.png" title="二维空间最佳逼近三维空间向量" width="400" >}}
...
<i><b style="color:gray">若复盘不成功, 建议看一下[前一章]({{< relref "vector-approximation.md" >}})</b></i>
...
将 $e$ 还原为 $ \sum\_{j \in \mathcal{I}\_s} c_j\psi_j(x) - f(x)$ 即可以得到线性方程组系统式 (\ref{eq:eq3}) 和式 (\ref{eq:eq4}).
...
下次主要介绍[程序以及一些扩展]({{< relref "function-approximation-orthogonal-basis.md" >}}) 🤘
