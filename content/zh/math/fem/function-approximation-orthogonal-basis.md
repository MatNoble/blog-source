+++
title = "有限元简述(3)：正交基函数与傅立叶级数"
description = "有限元简述系列第三篇。通过Matlab编程实例展示逼近函数的过程，并讨论了基函数选取的关键性。引入傅立叶级数作为正交基函数，分析其在消除系数矩阵病态性方面的优势，并简述吉布斯现象。"
categories = ["MATH","简述有限元"]
tags = ["有限元", "Matlab"]
keywords = ["有限元","FEM", "正交基函数", "傅立叶级数", "Matlab编程", "吉布斯现象", "病态矩阵"]
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/62f007ea-3d01-45a5-8ec7-4bfe52d009ed.jpeg" title="简述有限元: 逼近函数 II" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/a117f302-1844-4333-a1bf-5f911d308265.png" title="V = {1, x}" width="400" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/b9dc311d-dce7-4ea4-aff4-99fc163a4fcb.png" title="V = {1, x}" width="60%" >}}

程序计算结果与手算的是一样的.

当 $V = {\rm span}\\\\{1, x, x^2 \\\\}$ 时, 逼近解等于真解, 如下图所示

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/bf3d7a3a-6520-4fd7-9a43-af6b2496bf6b.png" title="V = {1, x}" width="400" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/32287d90-4eed-46e6-8a00-366df9ab381c.png" title="V = {1, x}" width="400" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/e68d6b8b-32c7-419a-8880-a6b4d91b2b54.png" title="病态缘由" width="65%" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/f1b331ac-c10b-4bb0-a040-91e332231194.png" title="N=3" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/47c04632-098b-4b3a-b924-e007e04ca50e.png" title="N=11" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/e6828cb5-eba4-47ec-9f21-cc8f3f0ef019.png" title="N=3" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/c4b1dfac-2b1a-411f-a739-0129659489e7.png" title="结果展示 N=3" >}}
...
{{< imgcap src="https://imgkr.cn-bj.ufileos.com/6686289b-3010-426d-9431-00948025bff0.png" title="N=1" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/a1b9b8b2-f9c7-4ac1-82c7-80f3ba2f2721.png" title="N=3" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/c94c8996-52ec-4a21-9c61-0f5978e7cd79.png" title="N=7" >}}

{{< imgcap src="https://imgkr.cn-bj.ufileos.com/de762744-f909-4cf5-bd16-551a08d84924.png" title="N=15" >}}
...
讨论逼近函数的最后一种方法 -- [插值法]({{< relref "function-approximation-interpolation.md" >}}) 🤘
